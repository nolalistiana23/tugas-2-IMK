          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 125.0, 71.0),
                    size: Size(125.0, 71.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          ...
                          colors: [
                            const Color(0xfffb3f82),
                            const Color(0xff773049)
                          ],
                          stops: [0.0, 1.0],
                        ),
                      ),
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 78.0, 21.0),
                    size: Size(78.0, 49.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(27.0, 30.0, 25.0, 19.0),
                    size: Size(78.0, 49.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          ...
                          colors: [
                            const Color(0xfff8377b),
                            const Color(0xff762f48)
                          ],
                          stops: [0.0, 1.0],
                        ),
                      ),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(21.0, 11.0, 80.0, 49.0),
                    size: Size(125.0, 71.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(32.0, 30.0, 17.0, 19.0),
                          size: Size(80.0, 49.0),
                          pinBottom: true,
                          fixedWidth: true,
                          fixedHeight: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 116.7, 175.0),
                    size: Size(116.7, 365.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 190.0, 116.7, 175.0),
                    size: Size(116.7, 365.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              gradient: LinearGradient(
                                ...
                                colors: [
                                  const Color(0xffff4688),
                                  const Color(0xff712c45)
                                ],
                                stops: [0.0, 1.0],
                              ),
                            ),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(17.0, 13.0, 95.0, 48.0),
                    size: Size(125.0, 71.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
