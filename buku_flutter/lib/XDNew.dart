...
import './XDTrending.dart';
import 'package:adobe_xd/page_link.dart';
import './XDTopView.dart';
import './XDCompleted.dart';
import './XDGenre.dart';
import './XDArchive.dart';
import './XDProfile.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDNew extends StatelessWidget {
  XDNew({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 34.0, 19.0),
                    size: Size(34.0, 20.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 18.0, 34.0, 2.0),
                    size: Size(34.0, 20.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 18.0, 77.0, 2.0),
                    size: Size(77.0, 20.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 18.0, 71.0, 2.0),
                    size: Size(71.0, 20.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 87.0, 19.0),
                    size: Size(87.0, 20.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 18.0, 87.0, 2.0),
                    size: Size(87.0, 20.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
